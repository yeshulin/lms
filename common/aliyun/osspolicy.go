...
var (
	accessKeyId     string = beego.AppConfig.String("ossaccessKeyId")
	accessKeySecret string = beego.AppConfig.String("ossaccessKeySecret")
	host            string = beego.AppConfig.String("osshost")
	expire_time     int64  = 60
	upload_dir      string = beego.AppConfig.String("ossupload_dir")
)
